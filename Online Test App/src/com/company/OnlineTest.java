...
class OnlineTest extends JFrame implements ActionListener {
    ...
    OnlineTest(String s) {
        ...
        radioButton[0].setBounds(50, 100, 200, 20);
        radioButton[1].setBounds(50, 150, 200, 20);
        radioButton[2].setBounds(250, 100, 200, 20);
        radioButton[3].setBounds(250, 150, 200, 20);
    ...
    void set() {
        ...
        if (current == 1) {
            label.setText("Q.2:  Which feature of java 7 allows to not explicitly close IO resource?");
        ...
        if (current == 2) {
            label.setText("Q.3: SessionFactory is a thread-safe object.");
        ...
        if (current == 3) {
            label.setText("Q.4: Which is the new method introduced in java 8 to iterate over a collection?");
        ...
        if (current == 4) {
            label.setText("Q.5:  What is the substitute of Rhino javascript engine in Java 8?");
        ...
        if (current == 5) {
            label.setText("Q.6: How to read entire file in one line using java 8?");
        ...
        if (current == 6) {
            label.setText("Q.7:  Which feature of java 7 allows to not explicitly close IO resource?");
            radioButton[0].setText("try catch finally");
            radioButton[1].setText("IOException");
            radioButton[2].setText("AutoCloseable");
            radioButton[3].setText("Streams");
        ...
        if (current == 7) {
            label.setText("Q.8:  Which of the following is not a core interface of Hibernate?");
        ...
        if (current == 8) {
            label.setText("Q.9: SessionFactory is a thread-safe object.");
            radioButton[0].setText("true");
            radioButton[1].setText("false");
            radioButton[2].setText("don't know");
            radioButton[3].setText("false");
        ...
        if (current == 9) {
            label.setText("Q.10: Which of the following is not a state of object in Hibernate?");
